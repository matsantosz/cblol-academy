            ...
            <div
                ...
                <div class="flex flex-1 sm:flex-none">
                    ...
                    >
                        ...
                        <button class="h-full flex items-center justify-center px-2" @click="search = ''"
                            x-show="search"
                        >
            ...
            @if ($profiles->count() > 0)
                <div class="flex flex-col divide-y divide-primary-border border-b border-primary-border">
                    @foreach ($profiles as $profile)
                        <a class="px-6 py-5 hover:bg-primary-bg" href="{{ route('profile.show', $profile) }}"
                            wire:navigate
                        >
                            <div class="flex items-center gap-4">
                                <div class="w-[96px] h-[96px]">
                                    <img class="w-24 rounded-full" src="{{ $profile->photo_url }}"
